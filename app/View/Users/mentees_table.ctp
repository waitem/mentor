...
<div class="users">
    ...
    <div class="right button noprint">
        <?php if (!(array_key_exists('inactive', $this->params['named']) && $this->params['named']['inactive'] == 'true')) : ?>
            <a href="<?php echo Router::url(array('controller' => 'users', 'action' => 'list_mentees', 'email' => 'true')); ?>">E-Mail
                Mentees</a>
            <a href="<?php echo Router::url(array('controller' => 'users', 'action' => 'mentees_csv')); ?>">Download
                CSV</a>
    ...
    <table cellpadding="0" cellspacing="0">
        <tr>
            ...
            <th><?php echo $this->Paginator->sort('SecondMentor.name', $secondMentorLabel); ?></th>
