 ...
 * TestUsersController *
 */
class UsersControllerCoordinatorTest extends UsersController {
/**
 * Auto render
 *
 * @var boolean
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Users = new UsersControllerCoordinatorTest();
 ...
 */
	...
	//}
        ...
        public function testCoordinatorLogin() {
            $good_data = array(
                'User' => array(
        ...
        public function testInactiveCoordinatorLogin() {
            $good_data = array(
                'User' => array(
            ...
            $result = $this->testAction('/users/view/10', array( 'return' => 'contents', 'method' => 'get'));
        ...
        public function testActiveCoordinatorTenant1Login() {
            $good_data = array(
                'User' => array(
                    'email' => 'coordinator1@tenant1.com',
                    'password' => 'password'
            ...
            // Now try to pull up the user's home screen
            $result = $this->testAction('/users/view/6', array( 'return' => 'contents', 'method' => 'get'));
